...
namespace SATOMI.Pages
{
    ...
    {
        public static void ClearCache(string fileLoc)
        {
            string saveDir = GetCachingDirectory(fileLoc);
            if (Directory.Exists(saveDir))
            {
                Directory.Delete(saveDir, true); // Recursively deletes the directory and all its contents.
            }
        }
